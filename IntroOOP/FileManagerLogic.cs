...
public class FileManagerLogic
{
    ...
    public FileManagerLogic(IUserInterface userInterface)
    {
        ...
        Commands = new Dictionary<string, FileManagerCommand>
        {
            ...
            {"clear", new ClearConsoleCommand(this) },                       //clear
            {"info", new TextFileInformationCommand(userInterface, this) },  //info [path]
            {"attr", new SetAttributeFileCommand(userInterface, this) }      //attr [path] [attribute name]
